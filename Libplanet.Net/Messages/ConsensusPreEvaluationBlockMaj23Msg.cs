...
namespace Libplanet.Net.Messages
{
    ...
    /// </summary>
    public class ConsensusPreEvaluationBlockMaj23Msg : ConsensusMsg
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusPreEvaluationBlockMaj23Msg"/>
        /// class.
        /// </summary>
        /// <param name="maj23">A <see cref="Maj23"/> of given height and round.</param>
        public ConsensusPreEvaluationBlockMaj23Msg(PreEvaluationBlockMaj23 maj23)
        ...
        public ConsensusPreEvaluationBlockMaj23Msg(byte[][] dataframes)
            : this(maj23: new PreEvaluationBlockMaj23(dataframes[0]))
        {
        }
        ...
        public override MessageType Type => MessageType.ConsensusPreEvaluationBlockMaj23Msg;

        /// <inheritdoc cref="ConsensusMsg.Equals(ConsensusMsg?)"/>
        public override bool Equals(ConsensusMsg? other)
        {
            return other is ConsensusPreEvaluationBlockMaj23Msg message &&
