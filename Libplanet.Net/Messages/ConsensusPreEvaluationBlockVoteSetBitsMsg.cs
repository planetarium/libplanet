...
namespace Libplanet.Net.Messages
{
    ...
    /// </summary>
    public class ConsensusPreEvaluationBlockVoteSetBitsMsg : ConsensusMsg
    {
        /// <summary>
        ...
        public ConsensusPreEvaluationBlockVoteSetBitsMsg(VoteSetBits voteSetBits)
            : base(
        ...
        public ConsensusPreEvaluationBlockVoteSetBitsMsg(byte[][] dataframes)
        ...
        public override MessageType Type => MessageType.ConsensusPreEvaluationBlockVoteSetBitsMsg;

        /// <inheritdoc cref="ConsensusMsg.Equals(ConsensusMsg?)"/>
        public override bool Equals(ConsensusMsg? other)
        {
            return other is ConsensusPreEvaluationBlockVoteSetBitsMsg message &&
        ...
        {
            return obj is ConsensusPreEvaluationBlockVoteSetBitsMsg other && Equals(other);
        }
