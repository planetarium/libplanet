...
namespace Libplanet.Blockchain
{
        ...
        where T : IAction, new()
    {
        ...
        /// by default or if it is <see langword="null"/>.  Note that action renderers receive events made
        ...
        /// <returns>
        /// <see langword="true"/> if the <see cref="BlockChain{T}"/> contains <see cref="Block{T}"/> with
        ...
        /// the state.  It will be The tip of the <see cref="BlockChain{T}"/> if it is <see langword="null"/>.
        /// </param>
        ...
        /// </param>
        /// <returns>The current state of given <paramref name="address"/>.  This can be <see langword="null"/>
        ...
        /// </param>
        /// <returns><see langword="true"/> if staging was successful, <see langword="false"/> otherwise.</returns>
        ...
        /// <returns><see langword="true"/> if unstaging was successful, <see langword="false"/> otherwise.</returns>
