...
namespace Libplanet.Blocks
{
        ...
        where T : IAction, new()
    {
        ...
        public PreEvaluationBlock(IBlockContent<T> content)
            : base(new BlockContent<T>(content))
        {
        }
        ...
        /// cref="BlockContent{T}.Propose()"/> method.</remarks>
        internal PreEvaluationBlock(BlockContent<T> content)
            : base(content)
        {
        }
        ...
        /// This must match to the block's <see cref="PreEvaluationBlockHeader.Proposer"/> and
