...
namespace Libplanet.Tests.Blocks
{
    public class BlockTest : IClassFixture<BlockFixture>
    {
        ...
        public void CanMine()
        {
            ...
            AssertBytesEqual(
                new HashDigest<SHA256>(
                    new byte[]
                    {
                        0xb6, 0xa5, 0x31, 0xad, 0x63, 0x5c, 0x1c, 0xc1, 0x06, 0xd1, 0x9c, 0xc6,
                        0x19, 0x37, 0x65, 0xfa, 0x41, 0x24, 0x07, 0x67, 0x10, 0xc7, 0x4b, 0x40,
                        0x0b, 0xa5, 0x3e, 0x44, 0x40, 0x9c, 0xdb, 0x6a,
                    }
                ),
                _fx.Genesis.Hash
            );
        ...
        {
            byte[] expected = new byte[192]
            {
                ,
            };
        ...
        {
            byte[] encoded = new byte[777]
                {
                    ,
        ...
        public void CanConvertToRaw()
        {
            ...
            AssertBytesEqual(
                new byte[32]
                {
                    0xb6, 0xa5, 0x31, 0xad, 0x63, 0x5c, 0x1c, 0xc1, 0x06, 0xd1, 0x9c, 0xc6, 0x19,
                    0x37, 0x65, 0xfa, 0x41, 0x24, 0x07, 0x67, 0x10, 0xc7, 0x4b, 0x40, 0x0b, 0xa5,
                    0x3e, 0x44, 0x40, 0x9c, 0xdb, 0x6a,
                },
                rawGenesis.Hash
            );

            RawBlock rawNext = _fx.Next.ToRawBlock(true, false);
            ...
            Assert.Null(rawNext.TxHash);
            AssertBytesEqual(
                new byte[32]
                {
                    0x50, 0xd7, 0x17, 0x33, 0xa7, 0xb6, 0x27, 0x3d, 0x02, 0x8a, 0x11, 0xb8, 0xf1,
                    0x56, 0xf8, 0xbf, 0xb8, 0x13, 0x15, 0x95, 0x3e, 0xd7, 0x50, 0x9a, 0x26, 0x9c,
                    0x40, 0xc3, 0x14, 0x14, 0xef, 0xda,
                },
                rawNext.Hash
            );

            RawBlock rawHasText = _fx.HasTx.ToRawBlock(true, false);

            Assert.Equal(2, rawHasText.Index);
            Assert.Equal(1, rawHasText.Difficulty);
            Assert.Equal(rawNext.Hash, rawHasText.PreviousHash);
            Assert.Equal("2018-12-01T00:00:00.000000Z", rawHasText.Timestamp);
            Assert.Equal(
                ByteUtil.ParseHex("21744f4f08db23e044178dafb8273aeb5ebe6644"),
                rawHasText.Miner
            );
            ...
            AssertBytesEqual(
                new byte[32]
                {
                    0x7f, 0x16, 0xd7, 0x1d, 0x3a, 0x25, 0xe7, 0x14, 0xf2, 0xf7, 0xf7, 0x79, 0x34,
                    0x64, 0x62, 0x25, 0x38, 0x8a, 0xa6, 0x21, 0x7d, 0xde, 0xcc, 0x20, 0x13, 0x0d,
                    0x77, 0x5c, 0xfe, 0x2a, 0x8c, 0x6c,
                },
                rawHasText.TxHash
            );
            AssertBytesEqual(
                new byte[32]
                {
                    0xcc, 0x9a, 0x4f, 0xcf, 0x27, 0xd8, 0xe4, 0x54, 0xf0, 0x17, 0x39, 0x3b, 0xf0,
                    0xbe, 0xfd, 0x34, 0xe4, 0x40, 0x28, 0x29, 0x8f, 0xe8, 0x6e, 0xc9, 0x11, 0x68,
                    0x41, 0xda, 0xf5, 0x44, 0xd0, 0x8e,
                },
                rawHasText.Hash
            );
        }
