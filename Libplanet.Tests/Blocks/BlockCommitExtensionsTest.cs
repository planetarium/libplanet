...
namespace Libplanet.Tests.Blocks
{
    public class BlockCommitExtensionsTest
    {
         ...
         [Fact]
         public void HasVotesSameHeight()
         {
             var hash = new BlockHash(TestUtils.GetRandomBytes(32));
             var sameHeight = new BlockCommit(
                 2,
                 0,
                 hash,
                 new[]
             ...
             Assert.True(sameHeight.HasVotesSameHeight());
             var differentHeight = new BlockCommit(
                 2,
                 0,
                 hash,
                 new[]
             ...
             Assert.False(differentHeight.HasVotesSameHeight());
         }
    }
}
