...
namespace Libplanet.Tests.Net
{
    public class SwarmTest : IDisposable
    {
        ...
        public async Task CanGetBlock()
        {
            ...
            Block<DumbAction, DumbAction> genesis = chainA.MineBlock(_fx1.Address1);
            chainB.Append(genesis); // chainA and chainB shares genesis block.
            Block<DumbAction, DumbAction> block1 = chainA.MineBlock(_fx1.Address1);
            Block<DumbAction, DumbAction> block2 = chainA.MineBlock(_fx1.Address1);
            ...
            try
            {
                ...
                List<Block<DumbAction, DumbAction>> receivedBlocks =
