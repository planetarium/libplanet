    ...
    public class TransactionTest
    {
        ...
        public void Create()
        {
            ...
            AssertBytesEqual(
                new byte[]
                {
                    0x30, 0x45, 0x02, 0x21, 0x00, 0xcb, 0xcb, 0x8d, 0xed, 0x78, 0x80, 0x76, 0x3a,
                    0xdb, 0x0e, 0x1f, 0x80, 0xd4, 0xf6, 0x21, 0x50, 0x0f, 0xde, 0x23, 0x8b, 0x6f,
                    0xd8, 0xf5, 0x8b, 0xc8, 0xf2, 0x0a, 0x42, 0xd4, 0x4d, 0x43, 0x62, 0x02, 0x20,
                    0x5f, 0xd7, 0x19, 0xed, 0x12, 0x61, 0x1b, 0xc3, 0x94, 0xae, 0x60, 0x3b, 0x35,
                    0x53, 0xcc, 0xb2, 0xa8, 0x32, 0x19, 0xf9, 0x0d, 0xc7, 0xf0, 0xf1, 0xcd, 0xa8,
                    0x6b, 0xf3, 0x7e, 0x51, 0x85, 0xbd,
                },
                tx.Signature
            );
            AssertBytesEqual(
                new TxId(
                    new byte[]
                    {
                        0x94, 0x48, 0x72, 0xec, 0xea, 0x57, 0x7a, 0x3e, 0xe1, 0x2f, 0xcd, 0x23,
                        0xca, 0xb0, 0x0a, 0xad, 0xb6, 0xbe, 0x89, 0x14, 0xf9, 0x6b, 0x7e, 0xf1,
                        0x30, 0x94, 0xe0, 0x28, 0xeb, 0x4a, 0x85, 0xb4,
                    }
                ),
                tx.Id
            );
        ...
        public void MakeWithSignature()
        {
            ...
            {
                0x30, 0x44, 0x02, 0x20, 0x5f, 0x43, 0x87, 0xfd, 0x72, 0xfe, 0x3a, 0x93, 0xd1, 0x34,
                0x65, 0xb3, 0x01, 0x47, 0x60, 0x0d, 0xa8, 0x48, 0xcc, 0x1d, 0xa4, 0xbd, 0x9b, 0x3a,
                0x05, 0x6a, 0x75, 0x40, 0x3c, 0xbe, 0xf4, 0x5a, 0x02, 0x20, 0x07, 0xb8, 0xa6, 0x3e,
                0x5f, 0x6c, 0xa9, 0xd4, 0x17, 0xc8, 0x40, 0x1c, 0xc5, 0xd2, 0xb7, 0x55, 0x26, 0x99,
                0x30, 0xd7, 0xdf, 0x77, 0x9f, 0x94, 0x25, 0xd3, 0xa2, 0xa1, 0xfa, 0x71, 0x8c, 0x7a,
            };
            ...
            AssertBytesEqual(
                new TxId(
                    new byte[]
                    {
                        0x3c, 0x82, 0x50, 0x29, 0x89, 0xe5, 0x8a, 0x0b, 0xfa, 0x66, 0x47, 0x09,
                        0x99, 0xbc, 0xfd, 0xeb, 0xbd, 0x49, 0x3c, 0xbd, 0x3e, 0x1a, 0x74, 0x6b,
                        0xc7, 0x1c, 0x86, 0x5b, 0x30, 0x1f, 0xde, 0xed,
                    }
                ),
                tx.Id
            );
        ...
        public void ToBencodex()
        {
            byte[] expected =
            {
                ...
                0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x37, 0x30, 0x3a, 0x30, 0x44, 0x02, 0x20, 0x5f,
                0x43, 0x87, 0xfd, 0x72, 0xfe, 0x3a, 0x93, 0xd1, 0x34, 0x65, 0xb3, 0x01, 0x47, 0x60,
                0x0d, 0xa8, 0x48, 0xcc, 0x1d, 0xa4, 0xbd, 0x9b, 0x3a, 0x05, 0x6a, 0x75, 0x40, 0x3c,
                0xbe, 0xf4, 0x5a, 0x02, 0x20, 0x07, 0xb8, 0xa6, 0x3e, 0x5f, 0x6c, 0xa9, 0xd4, 0x17,
                0xc8, 0x40, 0x1c, 0xc5, 0xd2, 0xb7, 0x55, 0x26, 0x99, 0x30, 0xd7, 0xdf, 0x77, 0x9f,
                0x94, 0x25, 0xd3, 0xa2, 0xa1, 0xfa, 0x71, 0x8c, 0x7a, 0x75, 0x36, 0x3a, 0x73, 0x69,
                ...
                0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x6c, 0x65, 0x65,
            };
        ...
        public void ToBencodexWithActions()
        {
            var expected = new byte[]
            {
                ...
                0x65, 0x37, 0x31, 0x3a, 0x30, 0x45, 0x02, 0x21, 0x00, 0xff, 0x59, 0xff, 0x0e, 0x5b,
                0x9e, 0xbf, 0xd7, 0xaf, 0xe6, 0x90, 0xed, 0x8c, 0xd4, 0xd7, 0xa1, 0x6a, 0xb2, 0xdf,
                0xc4, 0x42, 0x11, 0xea, 0x9e, 0xff, 0x73, 0xa6, 0x1f, 0x86, 0x4e, 0xf7, 0xde, 0x02,
                0x20, 0x51, 0x34, 0xd5, 0x55, 0xbf, 0x1a, 0x51, 0xcd, 0x45, 0x78, 0xda, 0x01, 0xb4,
                0x6b, 0xe9, 0x95, 0x85, 0x88, 0x4e, 0x21, 0x26, 0xc1, 0x52, 0x66, 0xfd, 0xb7, 0x5d,
                0xe2, 0x18, 0xb0, 0xd6, 0x2e, 0x75, 0x36, 0x3a, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72,
                ...
                0x73, 0x65, 0x73, 0x6c, 0x32, 0x30, 0x3a, 0xc2, 0xa8, 0x60, 0x14, 0x07, 0x3d, 0x66,
                0x2a, 0x4a, 0x9b, 0xfc, 0xf9, 0xcb, 0x54, 0x26, 0x3d, 0xfa, 0x4f, 0x5c, 0xbc, 0x65,
                0x65,
            };
        ...
        public void FromBencodex()
        {
            ...
            AssertBytesEqual(
                new byte[]
                {
                    0x30, 0x44, 0x02, 0x20, 0x5f, 0x43, 0x87, 0xfd, 0x72, 0xfe, 0x3a, 0x93, 0xd1,
                    0x34, 0x65, 0xb3, 0x01, 0x47, 0x60, 0x0d, 0xa8, 0x48, 0xcc, 0x1d, 0xa4, 0xbd,
                    0x9b, 0x3a, 0x05, 0x6a, 0x75, 0x40, 0x3c, 0xbe, 0xf4, 0x5a, 0x02, 0x20, 0x07,
                    0xb8, 0xa6, 0x3e, 0x5f, 0x6c, 0xa9, 0xd4, 0x17, 0xc8, 0x40, 0x1c, 0xc5, 0xd2,
                    0xb7, 0x55, 0x26, 0x99, 0x30, 0xd7, 0xdf, 0x77, 0x9f, 0x94, 0x25, 0xd3, 0xa2,
                    0xa1, 0xfa, 0x71, 0x8c, 0x7a,
                },
                tx.Signature
            );
            AssertBytesEqual(
        ...
        public void FromBencodexWithActions()
        {
            ...
            AssertBytesEqual(
                new byte[]
                {
                    0x30, 0x45, 0x02, 0x21, 0x00, 0xff, 0x59, 0xff, 0x0e, 0x5b, 0x9e, 0xbf, 0xd7,
                    0xaf, 0xe6, 0x90, 0xed, 0x8c, 0xd4, 0xd7, 0xa1, 0x6a, 0xb2, 0xdf, 0xc4, 0x42,
                    0x11, 0xea, 0x9e, 0xff, 0x73, 0xa6, 0x1f, 0x86, 0x4e, 0xf7, 0xde, 0x02, 0x20,
                    0x51, 0x34, 0xd5, 0x55, 0xbf, 0x1a, 0x51, 0xcd, 0x45, 0x78, 0xda, 0x01, 0xb4,
                    0x6b, 0xe9, 0x95, 0x85, 0x88, 0x4e, 0x21, 0x26, 0xc1, 0x52, 0x66, 0xfd, 0xb7,
                    0x5d, 0xe2, 0x18, 0xb0, 0xd6, 0x2e,
                },
                tx.Signature
            );
            AssertBytesEqual(
                new TxId(
                    new byte[]
                    {
                        0xf0, 0x50, 0x3d, 0x0f, 0x71, 0x7b, 0x00, 0x6c, 0x41, 0x70, 0xba, 0x8f,
                        0x3f, 0x98, 0x61, 0x33, 0x32, 0xed, 0x18, 0x3d, 0x9d, 0x72, 0x7b, 0xc4,
                        0xe2, 0x9a, 0xc2, 0x1c, 0xbe, 0x27, 0xe4, 0x03,
                    }
                ),
                tx.Id
            );
