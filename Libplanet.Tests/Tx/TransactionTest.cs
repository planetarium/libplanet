    ...
    public class TransactionTest
    {
        ...
        public void CreateWithCustomActions()
        {
            ...
            Transaction tx = Transaction.Create(
                ...
                privateKey,
                null,
                new[] { new DumbAction(stateStore, "Foo") },
            ...
            AssertBytesEqual(
                new byte[]
                {
                    0x30, 0x44, 0x02, 0x20, 0x74, 0x78, 0xc4, 0xce, 0xe1, 0x73, 0x23, 0xd7, 0x79,
                    0x54, 0xcc, 0x5d, 0x4a, 0xe7, 0xfa, 0x97, 0x62, 0x3c, 0x8a, 0xc6, 0xb5, 0x8b,
                    0x0c, 0x93, 0x02, 0x98, 0xc4, 0xfd, 0xee, 0x59, 0xfb, 0x2a, 0x02, 0x20, 0x26,
                    0xe2, 0xf3, 0x70, 0xa8, 0x2f, 0x24, 0x56, 0x67, 0x82, 0x8c, 0xfa, 0xff, 0xc8,
                    0x21, 0xdd, 0x8c, 0x64, 0x98, 0x7e, 0x2f, 0x6c, 0xc6, 0x0f, 0x4b, 0x5d, 0xf4,
                    0x2e, 0xe5, 0xcd, 0xa5, 0x47,
                },
                tx.Signature
            );
            AssertBytesEqual(
                new TxId(
                    new byte[]
                    {
                        0x3d, 0xeb, 0xb1, 0x20, 0x71, 0x08, 0x6e, 0x31, 0x0e, 0x34, 0x1f, 0xd0,
                        0xd3, 0x27, 0xb7, 0x26, 0xef, 0xc4, 0x29, 0x56, 0x4a, 0x33, 0xbc, 0xa0,
                        0xcc, 0xfa, 0xc4, 0x4f, 0xf7, 0x04, 0xe0, 0xfa,
                    }
                ),
                tx.Id
            );
