    ...
    public class TransactionTest
    {
        ...
        public void Create()
        {
            ...
            AssertBytesEqual(
                new byte[]
                {
                    0x30, 0x45, 0x02, 0x21, 0x00, 0x8a, 0x2a, 0x70, 0x35, 0xbb,
                    0x6f, 0xaf, 0x01, 0x7a, 0x68, 0xdc, 0x45, 0xaf, 0xf3, 0xe5,
                    0x19, 0x5e, 0xa7, 0x30, 0x9e, 0x38, 0x13, 0x3d, 0xa8, 0xf3,
                    0x71, 0x10, 0x93, 0x96, 0x11, 0x98, 0xcd, 0x02, 0x20, 0x38,
                    0x94, 0x6a, 0xfa, 0xa8, 0x6c, 0xa8, 0xb3, 0x1f, 0x12, 0xfd,
                    0x17, 0xa2, 0x57, 0x60, 0x05, 0xd6, 0x7a, 0x82, 0xfe, 0x4c,
                    0x8d, 0xcf, 0xf7, 0x9d, 0x00, 0xc3, 0x7f, 0x70, 0xd8, 0x31,
                    0xb4,
                },
                tx.Signature
            );
            AssertBytesEqual(
                new TxId(
                    new byte[]
                    {
                        0xa4, 0xf0, 0xcc, 0x43, 0x63, 0xf7, 0x7a, 0xb5, 0x2b, 0x98,
                        0x89, 0x5b, 0x98, 0xc7, 0xa8, 0x6c, 0xdd, 0x4b, 0x9a, 0x49,
                        0x5a, 0x9d, 0x90, 0xcb, 0xd5, 0x07, 0xd0, 0x03, 0x2a, 0xf1,
                        0xc5, 0x99,
                    }
                ),
                tx.Id
        ...
        public void MakeWithSignature()
        {
            ...
            {
                0x30, 0x44, 0x02, 0x20, 0x41, 0xbe, 0x96, 0x8c, 0x65, 0xe2, 0x15, 0xe3, 0xd1, 0xc8,
                0x71, 0x1e, 0xa3, 0x34, 0x14, 0x09, 0xdd, 0x1a, 0x0f, 0xbf, 0xce, 0x56, 0x30, 0xde,
                0xb3, 0x84, 0xd2, 0x57, 0xc5, 0xba, 0x82, 0x21, 0x02, 0x20, 0x79, 0x0e, 0x25, 0x0f,
                0xb8, 0xf7, 0x1e, 0x4a, 0x0d, 0xe4, 0x19, 0xb9, 0xd9, 0x77, 0xff, 0xe7, 0x8b, 0xd3,
                0x35, 0xeb, 0x4e, 0x26, 0xf8, 0x5a, 0x98, 0xb8, 0x53, 0x85, 0xbb, 0x37, 0xcf, 0x1e,
            };
            ...
            AssertBytesEqual(
                new TxId(
                    new byte[]
                    {
                        0x6e, 0x21, 0xf0, 0x2f, 0xea, 0x85, 0xa9, 0x5c, 0x39, 0xb0, 0x2a, 0x22,
                        0xa9, 0x60, 0xf3, 0x75, 0x18, 0xd0, 0x4f, 0x56, 0x58, 0x59, 0xa3, 0x02,
                        0x3c, 0x8f, 0x6a, 0x0d, 0x11, 0x18, 0x68, 0x8e,
                    }
                ),
                tx.Id
            );
        ...
        public void ToBencodex()
        {
            byte[] expected =
            {
                0x64, 0x75, 0x37, 0x3a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x6c, 0x65, 0x75,
                0x35, 0x3a, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x69, 0x30, 0x65, 0x75, 0x31, 0x30, 0x3a,
                0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b, 0x65, 0x79, 0x36, 0x35, 0x3a, 0x04,
                ...
                0xc8, 0xc4, 0x91, 0xae, 0xd3, 0xaa, 0xa2, 0x96, 0x75, 0x39, 0x3a, 0x73, 0x69, 0x67,
                0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x37, 0x30, 0x3a, 0x30, 0x44, 0x02, 0x20, 0x41,
                0xbe, 0x96, 0x8c, 0x65, 0xe2, 0x15, 0xe3, 0xd1, 0xc8, 0x71, 0x1e, 0xa3, 0x34, 0x14,
                0x09, 0xdd, 0x1a, 0x0f, 0xbf, 0xce, 0x56, 0x30, 0xde, 0xb3, 0x84, 0xd2, 0x57, 0xc5,
                0xba, 0x82, 0x21, 0x02, 0x20, 0x79, 0x0e, 0x25, 0x0f, 0xb8, 0xf7, 0x1e, 0x4a, 0x0d,
                0xe4, 0x19, 0xb9, 0xd9, 0x77, 0xff, 0xe7, 0x8b, 0xd3, 0x35, 0xeb, 0x4e, 0x26, 0xf8,
                0x5a, 0x98, 0xb8, 0x53, 0x85, 0xbb, 0x37, 0xcf, 0x1e, 0x75, 0x36, 0x3a, 0x73, 0x69,
                ...
                0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x30, 0x3a, 0x65,
            };
        ...
        public void ToBencodexWithActions()
        {
            ...
            {
                0x64, 0x75, 0x37, 0x3a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x6c, 0x64, 0x75,
                ...
                ,
            };
        ...
        public void FromBencodex()
        {
            var bytes = new byte[]
            {
                ...
                0x73, 0x6c, 0x65, 0x75, 0x35, 0x3a, 0x6e, 0x6f, 0x6e, 0x63,
                0x65, 0x69, 0x30, 0x65, 0x75, 0x31, 0x30, 0x3a, 0x70, 0x75,
                ...
                ,
                ...
                0x30, 0x30, 0x30, 0x30, 0x30, 0x5a, 0x75, 0x31, 0x37, 0x3a,
                0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x64,
                0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x30, 0x3a, 0x65,
            };
            ...
            AssertBytesEqual(
                new byte[]
                {
                    0x30, 0x44, 0x02, 0x20, 0x41, 0xbe, 0x96, 0x8c, 0x65, 0xe2,
                    0x15, 0xe3, 0xd1, 0xc8, 0x71, 0x1e, 0xa3, 0x34, 0x14, 0x09,
                    0xdd, 0x1a, 0x0f, 0xbf, 0xce, 0x56, 0x30, 0xde, 0xb3, 0x84,
                    0xd2, 0x57, 0xc5, 0xba, 0x82, 0x21, 0x02, 0x20, 0x79, 0x0e,
                    0x25, 0x0f, 0xb8, 0xf7, 0x1e, 0x4a, 0x0d, 0xe4, 0x19, 0xb9,
                    0xd9, 0x77, 0xff, 0xe7, 0x8b, 0xd3, 0x35, 0xeb, 0x4e, 0x26,
                    0xf8, 0x5a, 0x98, 0xb8, 0x53, 0x85, 0xbb, 0x37, 0xcf, 0x1e,
                },
                tx.Signature
            );
            AssertBytesEqual(
        ...
        public void FromBencodexWithActions()
        {
            ...
            AssertBytesEqual(
                new TxId(
                    new byte[]
                    {
                        0xf1, 0x62, 0x53, 0x3c, 0x66, 0x06, 0x27, 0x5a, 0xa8, 0x8b, 0x51, 0xf7,
                        0xe0, 0xfb, 0xd6, 0x4d, 0x36, 0x67, 0xed, 0xdf, 0xec, 0x96, 0xc9, 0x5b,
                        0xbf, 0x8e, 0xa4, 0xc3, 0xfa, 0x18, 0x50, 0xdc,
                    }
                ),
                tx.Id
            );
