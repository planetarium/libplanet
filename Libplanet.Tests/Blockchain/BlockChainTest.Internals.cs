...
namespace Libplanet.Tests.Blockchain
{
    public partial class BlockChainTest
    {
        ...
        public void ListStagedTransactions()
        {
            ...
            // 우리가 인위적으로 만들어야 하는 corner cases
            // A. 정상 케이스 (3 txs: 0, 1, 2)
            // B. 순서가 뒤집힌 nonce ( 2 tsx: 1, 0)
            // C. 작은 nonce가 나중 timestamp (2 txs: 0 (later), 1)
            // D. 이가 빠진 nonce (3 txs: 0, 1, 3)
            // E. nonce가 겹치는 경우 (4 txs: 0, 1, 1, 2)
