...
{
    public static TimeSpan Multiply(this TimeSpan @this, double factor)
    {
        ...
        double ticks = Math.Round(@this.Ticks * factor);
        return IntervalFromDoubleTicks(ticks);
    }

    public static TimeSpan Divide(this TimeSpan @this, double divisor)
    {
        // This code is borrowed from the official .NET implementation:
        ...
        double ticks = Math.Round(@this.Ticks / divisor);
        return IntervalFromDoubleTicks(ticks);
    }
    ...
    private static TimeSpan IntervalFromDoubleTicks(double ticks)
    {
        ...
        return ticks.Equals(long.MaxValue) ? TimeSpan.MaxValue : new TimeSpan((long)ticks);
    }
}
