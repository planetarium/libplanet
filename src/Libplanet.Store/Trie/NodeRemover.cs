...
internal sealed class NodeRemover
{
    ...
    {
        throw new NotSupportedException("HashNode is not supported in this context.");
        // return Remove(hashNode.Expand(keyValueStore), cursor);
    }
    ...
    private INode ReduceFullNode(FullNode fullNode)
    {
        ...
        else if (children.Count == 1)
        {
            ...
            child = child is HashNode hn ? throw new NotSupportedException("qwe") : child;
