...
namespace Libplanet.Types.Blocks
{
    ...
    public sealed class Block : IPreEvaluationBlock, IBlockHeader, IEquatable<Block>
    {
        ...
        /// <param name="evidences">The evidences to include.</param>
        ...
        public Block(
            ...
            : this(
                new PreEvaluationBlock(header, transactions, evidences),
        ...
        /// <inheritdoc cref="IBlockContent.Evidences"/>
        public IReadOnlyList<Evidence> Evidences => _preEvaluationBlock.Evidences;
