        ...
        : IEquatable<Evidence>, IComparable<Evidence>, IComparable, IBencodable
    {
        ...
        public static Evidence Decode(IValue value)
        {
            ...
            if (evidenceType.GetConstructor(new Type[] { typeof(IValue) }) is ConstructorInfo ctor)
            {
                ...
                return (Evidence)ctor.Invoke(args);
            }
            else
            {
        ...
        /// <summary>
        /// Deserialize <see cref="Evidence"/> from byte array.
        /// </summary>
        /// <param name="bytes">
        /// Byte array to be deserialized.
        /// </param>
        /// <returns>
        /// Deserialized <see cref="Evidence"/>.
        /// </returns>
        public static Evidence Deserialize(byte[] bytes) => Decode(Codec.Decode(bytes));

        /// <summary>
        /// Serialize <see cref="Evidence"/> to byte array.
        /// </summary>
        /// <returns>
        /// Serialized byte array of <see cref="Evidence"/>.
        /// </returns>
        ...
        public int CompareTo(Evidence? other) => Id.CompareTo(other?.Id);

        /// <inheritdoc cref="IComparable.CompareTo(object)"/>
        public int CompareTo(object? obj) => obj is Evidence other ? CompareTo(other: other) : 1;
