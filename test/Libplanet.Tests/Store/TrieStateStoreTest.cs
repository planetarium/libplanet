...
public class TrieStateStoreTest
{
    ...
    public static KeyBytes KeyFoo { get; } = new("foo");

    public static KeyBytes KeyBar { get; } = new("bar");

    public static KeyBytes KeyBaz { get; } = new("baz");

    public static KeyBytes KeyQux { get; } = new("qux");

    public static KeyBytes KeyQuux { get; } = new("quux");
    ...
    public void GetStateRoot()
    {
        ...
        KeyBytes fooKey = new("foo");
        KeyBytes barKey = new("bar");
        KeyBytes bazKey = new("baz");
        KeyBytes quxKey = new("qux");
