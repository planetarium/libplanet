...
public class MerkleTrieTest
{
    ...
    public void ConstructWithHashDigest()
    {
        ...
        var hashDigest = HashDigest<SHA256>.Create(GetRandomBytes(Size));
    ...
    public void IterateValues()
    {
        ...
        trie = trie
            .Set(KeyBytes.Create(0x01), Null.Value)
            .Set(KeyBytes.Create(0x02), Null.Value)
            .Set(KeyBytes.Create(0x03), Null.Value)
            .Set(KeyBytes.Create(0x04), Null.Value)
            .Set(KeyBytes.Create(0xbe, 0xef), Dictionary.Empty);
    ...
    public void Set(bool commit)
    {
        ...
        ITrie trie = stateStore.GetStateRoot(null);
        AssertBytesEqual(
            Parse("1b16b1df538ba12dc3f97edbb85caa7050d46c148134290feba80f8236c83db9"),
            trie.Hash
        );
