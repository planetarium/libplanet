...
public class MerkleTrieTest
{
    ...
    public void ConstructWithHashDigest()
    {
        ...
        var merkleTrie1 = new MerkleTrie(new HashNode(hashDigest) { KeyValueStore = store1 });
        ...
        var merkleTrie2 = new MerkleTrie();
    ...
    public void ConstructWithRootNode()
    {
        ...
        var merkleTrie = new MerkleTrie(node);
    ...
    public void IterateSubTrie(bool commit, string extraKey)
    {
        ...
        var prefixKey = KeyBytes.Create(Encoding.ASCII.GetBytes(prefix));
    ...
    public void RemoveValue()
    {
        ...
        Assert.Empty(trie.ToDictionary());
        ...
        foreach (var kv in kvs)
        {
            ...
            trie = stateStore.Commit(trie);
            expected.Push(
                (trie.Hash, trie.IterateNodes().Count(), trie.ToDictionary().Count));
        }
        ...
        foreach (var kv in kvs)
        {
            ...
            Assert.Equal(tuple.Item3, trie.ToDictionary().Count);
