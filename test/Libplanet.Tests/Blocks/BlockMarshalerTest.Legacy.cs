...
#pragma warning disable MEN002  // Line must be no longer than 100 characters
            ...
            Assert.Equal(
                HashDigest<SHA256>.Create(ByteUtil.ParseHex("1cd4451624ef9c79e2c2fb5a8e791e4fa56a7d8c610c14a8a34ae175b5205cf7")),
                block.PreEvaluationHash);
            Assert.Equal(
                HashDigest<SHA256>.Create(ByteUtil.ParseHex("6a648da9e91c21aa22bdae4e35c338406392aad0db4a0f998c01a7d7973cb8aa")),
                block.StateRootHash);
            Assert.Equal(
            ...
            Assert.Equal(
                HashDigest<SHA256>.Create(ByteUtil.ParseHex("1bba9fcf4c8152c899ed1674ecbf4a6571c271922c0884ae809f91f037bed8fc")),
                block.PreEvaluationHash);
            Assert.Equal(
                HashDigest<SHA256>.Create(ByteUtil.ParseHex("6a648da9e91c21aa22bdae4e35c338406392aad0db4a0f998c01a7d7973cb8aa")),
                block.StateRootHash);
            ...
            Assert.Equal(
                HashDigest<SHA256>.Create(ByteUtil.ParseHex("e520162fef3516f4c0ccd6f79cc0c50f6e3bf7c53b1bf425b5e1931089e3fd8a")),
                block.PreEvaluationHash);
            Assert.Equal(
                HashDigest<SHA256>.Create(ByteUtil.ParseHex("6a648da9e91c21aa22bdae4e35c338406392aad0db4a0f998c01a7d7973cb8aa")),
                block.StateRootHash);
            ...
            Assert.Equal(
                HashDigest<SHA256>.Create(ByteUtil.ParseHex("af519fa381741e58781ea58a43233d155c212351d9840ef69e0a3555f210ad50")),
                block.PreEvaluationHash);
            Assert.Equal(
                HashDigest<SHA256>.Create(ByteUtil.ParseHex("6a648da9e91c21aa22bdae4e35c338406392aad0db4a0f998c01a7d7973cb8aa")),
                block.StateRootHash);
