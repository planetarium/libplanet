    ...
    public class DuplicateVoteEvidenceTest
    {
        ...
        public async void CanProposeWithDuplicateVoteEvidence()
        {
            ...
            consensusContext.HandleMessage(new ConsensusPreCommitMsg(TestUtils.CreateVote(
                TestUtils.PrivateKeys[0], 3, hash: blockHash, flag: VoteFlag.PreCommit)));
            ...
            consensusContext.HandleMessage(new ConsensusPreCommitMsg(TestUtils.CreateVote(
                TestUtils.PrivateKeys[1], 3, hash: blockHash, flag: VoteFlag.PreCommit)));
            consensusContext.HandleMessage(new ConsensusPreCommitMsg(TestUtils.CreateVote(
                TestUtils.PrivateKeys[2], 3, hash: blockHash, flag: VoteFlag.PreCommit)));
        ...
        public async void IgnoreNillVote()
        {
            ...
            consensusContext.HandleMessage(new ConsensusPreCommitMsg(TestUtils.CreateVote(
                TestUtils.PrivateKeys[0], 3, hash: default, flag: VoteFlag.PreCommit)));
            consensusContext.HandleMessage(new ConsensusPreCommitMsg(TestUtils.CreateVote(
